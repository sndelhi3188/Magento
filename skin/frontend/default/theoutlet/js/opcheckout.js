...
Checkout.prototype = {
    ...
    reloadProgressBlock: function(){
        /* Commented this out to work with our theme. RICHARD CASTERA
			var updater = new Ajax.Updater($$('.col-right')[0], this.progressUrl, {method: 'get', onFailure: this.ajaxFailure.bind(this)});
		*/
        /* Commented by Richard Caster to have the ajax change the block instead of the column.
		var updater = new Ajax.Updater($$('.col-left')[0], this.progressUrl, {method: 'get', onFailure: this.ajaxFailure.bind(this)});
		*/
		var updater = new Ajax.Updater($$('.progress-fix')[0], this.progressUrl, {method: 'get', onFailure: this.ajaxFailure.bind(this)});
    },
