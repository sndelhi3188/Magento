...
class Bestylish_Testview_Block_Adminhtml_Testview_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		public function getHeaderText()
		{
				if( Mage::registry("testview_data") && Mage::registry("testview_data")->getId() ){
				    ...
				    return Mage::helper("testview")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("testview_data")->getId()));
