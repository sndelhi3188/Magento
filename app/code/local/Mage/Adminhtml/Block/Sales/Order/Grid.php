...
class Mage_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	$sku = 'tshirt_red';
        ...
        //$stat = Mage::getSingleton('payment/config')->getActivPaymentMethods();
        //$status = Mage::getSingleton('sales/order_config')->getStatuses();
	//$status =new Inchoo_Vendor_Model_Activpayment();
	//$stat = $status->getActivPaymentMethods();
	//	print_r($status);
		//print_r("</br>");
		//print_r($status);
    }
    ...
    protected function _prepareCollection()
	{
		...
		'main_table.entity_id = sfop.parent_id',array('sfop.method'));
		...
		'sfo.base_grand_total','sfo.grand_total','sfo.entity_id','sfo.customer_id'));
    ...
    protected function _prepareColumns()
    {
       ...
       $this->addColumn('real_order_id', array(
			...
			$this->addColumn('sfo_customer_id', array(
			'header' => Mage::helper('sales')->__('Cust_Id'),
			'index' => 'customer_id',
			'type' => 'text',
			'filter_index' => 'sfo.customer_id',
			'width' => '50px',
			));
            ...
            $this->addColumn('sfop_method', array(
			'header' => Mage::helper('sales')->__('Payment Via'),
			'index' => 'method',
			'filter_index' => 'sfop.method',
			'type' => 'options',
			'width' => '50px',
			'options' => Mage::getSingleton('payment/config')->getActivPaymentMethods(),
			));
